            ...
            <tbody>
                <tr>
                    <td class="col1 form_users_edit_mail">
                        <input type="text" name="login" size="20" value="<?php echo $user['login']; ?>" />
                    </td>
                    <td class="col2 form_users_edit_mdp">
                        <input type="password" name="password" size="20" value="<?php echo $user['password']; ?>" />
                    </td>
                    <td class="col3 form_users_edit_mdp_confirm">
                        <input type="password" name="password_conf" size="20" value="<?php echo $user['password']; ?>" />
                    </td>
