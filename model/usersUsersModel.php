...
class usersUsersModel extends usersUsersModel_Parent
{
     ...
     * @return void
     */
    public function getUsers ($id_parent = null, $max_depth = 0, $min_depth = 0, $params = null)
    {
        $db = $this->getModel('db');
        if (!$id_parent) {
            if ($max_depth || $min_depth) {
                // TODO: permettre de rechercher avec un niveau de profondeur mini / maxi meme sans id_parent
                return array();
            }
